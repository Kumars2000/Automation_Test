...
public interface ActionInterface {
	...
	void checkEnable(WebDriver driver, WebElement ele);
	public String getText(WebDriver driver, WebElement ele);
	public void validate_map_data(WebDriver driver, HashMap<String, Integer> map1, HashMap<String, Integer> map2,
			String valid_statement, String Invalid_statement);
